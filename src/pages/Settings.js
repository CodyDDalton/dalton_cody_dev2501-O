...
import SettingsLogo from "../images/settingsAmb.png";
...
function Settings() {
        ...
        <ul>
          ...
          <li id="navLinks" style={styles.linkList}>
            <img src={SpendingLogo} alt="spending" style={styles.linkLogos} />
              <Link id="linkId" to="/spending"><h3 id="username" style={styles.linkLabels}>Spending</h3></Link>
          </li>
          </ul>
          </nav>
          <div id="pageTopper" style={styles.pageTopper}>
            <img src={SettingsLogo} alt="settings" style={styles.pageLogo} />
            <div style={styles.titleSpot}>
                <h1 id="pageTitle" style={styles.pageTitle}>Settings</h1>
    ...
    <div style={styles.right}>
      <head style={styles.head}>
        ...
        <Link id="linkId" to="/settings"><h3 style={styles.userName}>John Smith</h3></Link>
      </head>
